...
const CommentFrom = ({ slug }) => {
    ...
    return (
        <div className="bg-black bg-opacity-20 shadow-lg rounded-lg p-8 pb-12 mb-8">
            <h3 className=" text-4xl text-center mb-8 font-semibold border-b pb-4">
            ...
            <div className="mt-8">
                <button
                    ...
                    className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-indigo-500 text-white text-lg p-2 rounded-lg w-full cursor-pointer"
                >
                    Post Comment
                </button>
                {showSuccessMessage && (
